...
import { BrooklynConcepts } from '@/features/brooklyn/concepts'
import { BrooklynScanner } from '@/features/brooklyn/scanner'
import { BrooklynInstall } from '@/features/brooklyn/install'
...
export const Route = createFileRoute('/brooklyn/')({
  component: BrooklynIndexPage,
})

function BrooklynIndexPage() {
