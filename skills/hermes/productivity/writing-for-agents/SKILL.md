...
description: "Reference for writing documents for agents (skills, AGENTS.md, CLAUDE.md). Focuses on predictability, progressive disclosure, and deleting no-ops."
version: 1.2.3
...
metadata:
  hermes:
    tags: [meta, skill-authoring, agents-md, best-practices]
