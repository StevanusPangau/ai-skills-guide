---
name: prototype
description: "Build a throwaway prototype to answer a design question. Use when the user wants to sanity-check whether a state mode..."
version: 1.0.0
...
metadata:
  hermes:
    tags: [prototyping, exploration, design]
