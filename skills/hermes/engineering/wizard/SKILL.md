---
name: wizard
description: "Generate an interactive bash wizard that walks a human through steps only they can perform (provisioning, credentials, migrations)."
version: 1.2.3
...
metadata:
  hermes:
    tags: [wizard, automation, human-in-the-loop, setup]
